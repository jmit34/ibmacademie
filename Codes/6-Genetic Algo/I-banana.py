...
class Population():
    def __init__(self, pop_size):
        ...
        for i in range(self.pop_size):
            #self.minions.append(Minion(None,(WIDTH/2,HEIGHT-50), (random()-0.5,random()-0.5), (0,0)))
...
pygame.display.set_caption("9 : Now with an obstacle")
running = True
while running:
